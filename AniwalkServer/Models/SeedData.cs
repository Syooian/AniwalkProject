    ...
    public class SeedData
    {
        ...
        public static void Initialize(IServiceProvider ServiceProvider)
        {
                ...
                ServiceProvider.GetRequiredService<DbContextOptions<AniwalkDBContext>>()))
            {
                ...
                #region 會員狀態
                context.MemberStatus.Add(new MemberStatusCode() { StatusCode = 0, StatusName = "一般" });
                context.MemberStatus.Add(new MemberStatusCode() { StatusCode = 1, StatusName = "已封鎖" });
                context.MemberStatus.Add(new MemberStatusCode() { StatusCode = 2, StatusName = "已註銷" });
