...
namespace AniwalkServer.Migrations
{
    ...
    [Migration("20250821045944_AddSp_GetAnnouncements")]
    partial class AddSp_GetAnnouncements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AniwalkServer.DTOs.VisitsDTO", b =>
                {
            ...
            modelBuilder.Entity("AniwalkServer.Models.AddNewAnime", b =>
                {
                    b.Property<int>("SN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AniwalkServer.Models.ForgotPassword.ForgotPassword", b =>
                {
                    b.Property<int>("SN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("VerifyCodeExpiryDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AniwalkServer.Models.MemberStatus", b =>
                {
                    b.Property<string>("MemberID")
                        .HasColumnType("char(10)");
            ...
            modelBuilder.Entity("AniwalkServer.Models.MemberStatusCode", b =>
                {
                    b.Property<int>("StatusCode")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AniwalkServer.Models.Replies", b =>
                {
            ...
            modelBuilder.Entity("AniwalkServer.Models.VisitsDetails", b =>
                {
                    b.Property<int>("TagSN")
                        .HasColumnType("int");

                    b.Property<int>("VisitSN")
                        .HasColumnType("int");

                    b.HasKey("TagSN", "VisitSN");
            ...
            modelBuilder.Entity("AniwalkServer.Models.MemberStatus", b =>
                {
                    b.HasOne("AniwalkServer.Models.Members", "Member")
                        .WithOne("MemberStatus")
                        .HasForeignKey("AniwalkServer.Models.MemberStatus", "MemberID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AniwalkServer.Models.MemberStatusCode", "MemberStatusCode")
            ...
            modelBuilder.Entity("AniwalkServer.Models.Replies", b =>
                {
                    b.HasOne("AniwalkServer.Models.Comments", "Comment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("AniwalkServer.Models.VisitsDetails", b =>
                {
                    b.HasOne("AniwalkServer.Models.VisitsTags", "VisitsTag")
                    ...
                    b.HasOne("AniwalkServer.Models.Visits", "Visit")
                        .WithMany("VisitDetail")
                        .HasForeignKey("VisitSN")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Visit");

                    b.Navigation("VisitsTag");
                });
